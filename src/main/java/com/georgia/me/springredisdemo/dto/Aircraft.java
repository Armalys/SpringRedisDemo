package com.georgia.me.springredisdemo.dto;
...
public class Aircraft {
    ...
    public void setLastSeenTime(String lastSeenTime) {
        if (null != lastSeenTime) {
            ...
            this.lastSeenTime = Instant.ofEpochMilli(0);
        }
    }
    ...
    public void setPosUpdateTime(String posUpdateTime) {
        if (null != posUpdateTime) {
            ...
            this.posUpdateTime = Instant.ofEpochMilli(0);
        }
    }
    ...
    public void setBds40SeenTime(String bds40SeenTime) {
        if (null != bds40SeenTime) {
            ...
            this.bds40SeenTime = Instant.ofEpochMilli(0);
        }
    }
}
